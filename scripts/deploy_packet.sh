...
AI_VIDEO_GEN_STORAGE_PROFILE="${AI_VIDEO_GEN_STORAGE_PROFILE:-ephemeral}"
AI_VIDEO_GEN_EPHEMERAL_STORAGE_GB="${AI_VIDEO_GEN_EPHEMERAL_STORAGE_GB:-}"
...
AI_VIDEO_GEN_STORAGE_PROFILE="${AI_VIDEO_GEN_STORAGE_PROFILE}" \
AI_VIDEO_GEN_EPHEMERAL_STORAGE_GB="${AI_VIDEO_GEN_EPHEMERAL_STORAGE_GB}" \
