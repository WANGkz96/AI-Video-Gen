...
write_runtime_env() {
  ...
  write_env_value "AI_VIDEO_GEN_EXECUTION_PROFILE" "${AI_VIDEO_GEN_EXECUTION_PROFILE:-standard}"
  write_env_value "AI_VIDEO_GEN_TURBO_MAX_CONCURRENT_BRANCHES" "${AI_VIDEO_GEN_TURBO_MAX_CONCURRENT_BRANCHES:-2}"
  write_env_value "AI_VIDEO_GEN_TURBO_MIN_VRAM_GB" "${AI_VIDEO_GEN_TURBO_MIN_VRAM_GB:-160}"
  write_env_value "AI_VIDEO_GEN_PERSISTENT_MODEL_CACHE_DIR" "${AI_VIDEO_GEN_PERSISTENT_MODEL_CACHE_DIR:-}"
  write_env_value "AI_VIDEO_GEN_STORAGE_PROFILE" "${AI_VIDEO_GEN_STORAGE_PROFILE:-ephemeral}"
  write_env_value "AI_VIDEO_GEN_EPHEMERAL_STORAGE_GB" "${AI_VIDEO_GEN_EPHEMERAL_STORAGE_GB:-}"
  ...
  write_env_value "AI_VIDEO_GEN_MODEL_DOWNLOAD_CONCURRENCY" "${AI_VIDEO_GEN_MODEL_DOWNLOAD_CONCURRENCY:-1}"
